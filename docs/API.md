...
| [location] | <code>string</code> | <code>&quot;root.json&quot;</code> | The location of the document being processed |
...
| [options.relativeBase] | <code>string</code> |  | The base location to use when resolving relative references *(Deprecated, use `options.location` instead.  Only useful for APIs that do remote reference resolution.  If this value is not defined, [path-loader](https://github.com/whitlockjc/path-loader) will use `window.location.href` for the browser and `process.cwd()` for Node.js.)* |
