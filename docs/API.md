...
* [json-refs](#module_json-refs)
    ...
    * [.ResolvedRefDetails](#module_json-refs.ResolvedRefDetails) : <code>module:json-refs~UnresolvedRefDetails</code>
    * [.ResolvedRefsResults](#module_json-refs.ResolvedRefsResults) : <code>object</code>
    * [.RetrievedRefsResults](#module_json-refs.RetrievedRefsResults) : <code>module:json-refs~ResolvedRefsResults</code>
    ...
    * [.findRefsAt(location, [options])](#module_json-refs.findRefsAt) ⇒ <code>Promise.&lt;module:json-refs~RetrievedRefsResults&gt;</code>
    * [.getRefDetails(obj)](#module_json-refs.getRefDetails) ⇒ <code>module:json-refs~UnresolvedRefDetails</code>
    ...
    * [.resolveRefs(obj, [options])](#module_json-refs.resolveRefs) ⇒ <code>Promise.&lt;module:json-refs~ResolvedRefsResults&gt;</code>
    * [.resolveRefsAt(location, [options])](#module_json-refs.resolveRefsAt) ⇒ <code>Promise.&lt;module:json-refs~RetrievedResolvedRefsResults&gt;</code>
...
| refPreProcessor | <code>module:json-refs~RefPreProcessor</code> |  | The callback used to pre-process a JSON Reference like object *(This is called prior to validating the JSON Reference like object and getting its details)* |
| refPostProcessor | <code>module:json-refs~RefPostProcessor</code> |  | The callback used to post-process the JSON Reference metadata *(This is called prior filtering the references)* |
...
| --- | --- | --- |
| refDetails | <code>module:json-refs~UnresolvedRefDetails</code> | The JSON Reference details to test |
...
### json-refs.ResolvedRefDetails : <code>module:json-refs~UnresolvedRefDetails</code>
...
| fqURI | <code>string</code> | The fully-qualified version of the `uri` property for [module:json-refs~UnresolvedRefDetails](module:json-refs~UnresolvedRefDetails) but with the value being relative to the root document |
...
| Name | Type | Description |
| --- | --- | --- |
| refs | <code>module:json-refs~ResolvedRefDetails</code> | An object whose keys are JSON Pointers *(fragment version)* to where the JSON Reference is defined and whose values are [module:json-refs~ResolvedRefDetails](module:json-refs~ResolvedRefDetails) |
...
### json-refs.RetrievedRefsResults : <code>module:json-refs~ResolvedRefsResults</code>
...
| [options] | <code>module:json-refs~JsonRefsOptions</code> | The JsonRefs options |
...
### json-refs.findRefsAt(location, [options]) ⇒ <code>Promise.&lt;module:json-refs~RetrievedRefsResults&gt;</code>
...
**Kind**: static method of <code>[json-refs](#module_json-refs)</code>  
**Returns**: <code>Promise.&lt;module:json-refs~RetrievedRefsResults&gt;</code> - a promise that resolves a
[module:json-refs~RetrievedRefsResults](module:json-refs~RetrievedRefsResults) and rejects with an `Error` when the input arguments fail validation,
when `options.subDocPath` points to an invalid location or when the location argument points to an unloadable
resource  

| Param | Type | Description |
| --- | --- | --- |
| location | <code>string</code> | The location to retrieve *(Can be relative or absolute, just make sure you look at the [options documentation](module:json-refs~JsonRefsOptions) to see how relative references are handled.)* |
| [options] | <code>module:json-refs~JsonRefsOptions</code> | The JsonRefs options |
...
### json-refs.getRefDetails(obj) ⇒ <code>module:json-refs~UnresolvedRefDetails</code>
Returns detailed information about the JSON Reference.

**Kind**: static method of <code>[json-refs](#module_json-refs)</code>  
**Returns**: <code>module:json-refs~UnresolvedRefDetails</code> - the detailed information  
...
### json-refs.resolveRefs(obj, [options]) ⇒ <code>Promise.&lt;module:json-refs~ResolvedRefsResults&gt;</code>
Finds JSON References defined within the provided array/object and resolves them.

**Kind**: static method of <code>[json-refs](#module_json-refs)</code>  
**Returns**: <code>Promise.&lt;module:json-refs~ResolvedRefsResults&gt;</code> - a promise that resolves a
[module:json-refs~ResolvedRefsResults](module:json-refs~ResolvedRefsResults) and rejects with an `Error` when the input arguments fail validation,
when `options.subDocPath` points to an invalid location or when the location argument points to an unloadable
resource  
...
### json-refs.resolveRefsAt(location, [options]) ⇒ <code>Promise.&lt;module:json-refs~RetrievedResolvedRefsResults&gt;</code>
...
**Kind**: static method of <code>[json-refs](#module_json-refs)</code>  
**Returns**: <code>Promise.&lt;module:json-refs~RetrievedResolvedRefsResults&gt;</code> - a promise that resolves a
[module:json-refs~RetrievedResolvedRefsResults](module:json-refs~RetrievedResolvedRefsResults) and rejects with an `Error` when the input arguments fail
