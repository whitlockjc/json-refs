...
(function (global){
function times(i,n,a){if(i=floor(i),1>i||!nativeIsFinite(i))return[];var t=-1,e=Array(nativeMin(i,MAX_ARRAY_LENGTH));for(n=bindCallback(n,a,1);++t<i;)MAX_ARRAY_LENGTH>t?e[t]=n(t):n(t);return e}var bindCallback=require("../internal/bindCallback"),floor=Math.floor,nativeIsFinite=global.isFinite,nativeMin=Math.min,MAX_ARRAY_LENGTH=Math.pow(2,32)-1;module.exports=times;
...
},{"./lib/loaders/file":81,"./lib/loaders/http":82,"native-promise-only":79}],81:[function(require,module,exports){
...
},{"superagent":83}],83:[function(require,module,exports){
