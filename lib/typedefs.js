 ...
 *
 * @typedef {module:json-refs~ResolvedRefsResults} RetrievedRefsResults
 *
 ...
 * @property {module:json-refs~ResolvedRefsResults} resolved - An object whose keys are JSON Pointers *(fragment version)*
 * to where the JSON Reference is defined and whose values are {@link module:json-refs~ResolvedRefDetails}
 * @property {object} value - The retrieved document
 *
 * @memberof module:json-refs
